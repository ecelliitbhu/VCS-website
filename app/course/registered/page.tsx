      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-4">
          {weeks.map((w: any) => {
            ...
            // Custom classes for disabled state in Module 2 submission
            const disabledSubmissionClasses = "inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium border bg-slate-800/50 text-slate-500 border-slate-700/50 cursor-not-allowed opacity-60";
                      ...
                      <div className="flex items-center gap-4 flex-wrap">
                        ...
                        {isModuleTwo ? (
                          <div className="flex items-center gap-3">
                            {/* Problem Statement Button (ACTIVE - Orange) */}
                            <a
                            ...
                            {/* Submit Assignment Button (DISABLED - Gray) */}
                            <button disabled className={disabledSubmissionClasses}>
